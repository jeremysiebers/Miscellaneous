...
static unsigned char (*pToGreenLed1) = GreenLeds;
static unsigned char (*pToGreenLed2) = GreenLeds;
static unsigned char (*pToGreenLed3) = GreenLeds;
static unsigned char (*pToGreenLed4) = GreenLeds;
...
void main(void) {
    ...
    while(1)
    {
        ...
        if(PIR1bits.TMR1IF == false && NextFrame == true)
        {
            ...
            ImageCounter = OperateImage * 32;
            
            if(OperateLedsRow == 0){
                ActiveDisplayRow = 0xFE;
                pToGreenLed1, pToGreenLed2, pToGreenLed3, pToGreenLed4 = GreenLeds;
                pToGreenLed1 += 0  + ImageCounter;
                pToGreenLed2 += 1  + ImageCounter;
                pToGreenLed3 += 16 + ImageCounter;
                pToGreenLed4 += 17 + ImageCounter;
            }
            else if(OperateLedsRow == 1){
                ActiveDisplayRow = 0xFD;
                pToGreenLed1 += 2 + ImageCounter;
                pToGreenLed2 += 2 + ImageCounter;
                pToGreenLed3 += 2 + ImageCounter;
                pToGreenLed4 += 2 + ImageCounter;
            }
            else if(OperateLedsRow == 2){
            ...
            if (Run)
            {   
                GreenCol1Byte = *pToGreenLed1;
                GreenCol2Byte = *pToGreenLed2;
                GreenCol3Byte = *pToGreenLed3;
                GreenCol4Byte = *pToGreenLed4;
            ...
            else
            {
                ...
                RedCol1Byte = *pToGreenLed1;
                RedCol2Byte = *pToGreenLed2;
                RedCol3Byte = *pToGreenLed3;
                RedCol4Byte = *pToGreenLed4;
            }
        }
