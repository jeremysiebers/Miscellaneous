...
#define TIMER1_VAL 0xFFF0                                                       // Timer1 count value max is 207
...
void high_isr()
{
	...
	INTCONbits.TMR0IF = OFF;                                                // Clear Timer 0 interrupt flag
        ...
        PIR1bits.TMR1IF = ON;                                                   // Set timer 1 interrupt flag
    }
}
...
static void Init_Timers(void)
{
	...
	INTCONbits.GIEL		= 1;						// Disable low interrupts
